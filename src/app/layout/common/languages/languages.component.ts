...
export class LanguagesComponent implements OnInit, OnDestroy {
    ...
    /**
     * Get language ID from mixed type (string or LangDefinition)
     *
     * @param lang
     */
    getLangId(lang: string | { id: string; label: string }): string {
        return typeof lang === 'string' ? lang : lang.id;
    }

    /**
     * Get language label from mixed type (string or LangDefinition)
     *
     * @param lang
     */
    getLangLabel(lang: string | { id: string; label: string }): string {
